...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT_ansi_61(
        ...
        RGB_TOG, RGB_MOD,  RGB_VAI,  KC_SNAP,  RGB_SAI,  RGB_SPI,  _______,  _______,  KC_UP,    _______,  KC_PGDN,  KC_END,             _______,
    ...
    [_FN2] = LAYOUT_ansi_61(
        ...
        RGB_TOG, RGB_MOD,  RGB_VAI,  KC_PSCR,  RGB_SAI,  RGB_SPI,  _______,  _______,  KC_UP,    _______,  KC_PGDN,  KC_END,             _______,
        _______,           RGB_RMOD, RGB_VAD,  RGB_HUI,  RGB_SAD,  RGB_SPD,  NK_TOGG,  KC_LEFT,  KC_DOWN,  KC_RIGHT, _______,            _______,
        _______, _______,  _______,                                _______,                                _______,  _______,  _______,  _______),
