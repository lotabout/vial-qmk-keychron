/*
 * Vial keymap for Keychron K15 Max ANSI RGB (Encoder)
 * Standalone (no VIA includes). Eight layers: default Mac/Win pairs plus four blank user layers.
 */
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [USER_1]   = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
    [USER_2]   = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
    [USER_3]   = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
    [USER_4]   = { ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
};
#endif
