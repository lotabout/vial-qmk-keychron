/*
 * Vial keymap for Keychron K15 Max ANSI White (Encoder)
 * Standalone and mirrors RGB mapping with BL_* controls on FN.
 */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN] = LAYOUT_ansi_90(
        ...
        _______,  _______,  BL_STEP,  BL_DOWN,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,            KC_END,
